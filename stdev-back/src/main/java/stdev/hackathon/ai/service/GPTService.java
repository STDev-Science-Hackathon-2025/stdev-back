...
public class GPTService{
    ...
    public String askGPT(Long sessionId, String newQuestion) {
        ...
        String systemPrompt = """
            ...
            - 사용자가 너의 정체를 직접적으로 언급하면서 추측 질문을 한다면, (예: "너 산소야?", "혹시 수소 아니야?")
            - 그 정답이 정확히 오늘의 정체('%s')와 일치할 경우, 다음과 같이 응답하라:
            ...
            - 이 경우 게임은 종료된다. 이후 응답은 친절하고 과학적인 설명 모드로 전환해도 된다.
            - 틀린 정체명을 말할 경우에는 일반적인 Yes/No 규칙대로 답하고, 점수를 조금 깎아라.
            --
